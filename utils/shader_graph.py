...
def fetch_search_roots(graph, blacklist = {}):
    ...
    while len(node_stack) != 0:
        ...
        # Should we locate a viable node for texture packing, we append it to our roots list.
        elif not cur_node.node.bl_idname in blacklist:
            roots.append(cur_node)
    
    return roots

def grab_socket_images(mesh, g_node, socket):
